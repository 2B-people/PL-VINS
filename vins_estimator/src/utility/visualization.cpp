                ...
                Eigen::Matrix3d loop_correct_r)
{
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        ofstream foutC("/home/orin-nx1/catkin_ws/src/PL-VINS/Trajactory/tum_fast_no_loop.txt", ios::app);
        ...
        ofstream foutC1("/home/orin-nx1/catkin_ws/src/PL-VINS/Trajactory/evo_fast_no_loop.txt", ios::app);
